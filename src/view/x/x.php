...
<div id="wp-share-buttons-x-<?php echo esc_attr( $post_id ); ?>"
	class="wp-share-button wp-share-button--<?php echo esc_attr( $type ); ?> wp-share-button--x"
...
>
	...
	<a class="wp-share-button__button" href="<?php echo esc_url( 'https://twitter.com/intent/tweet?' . http_build_query( $query, '', '&amp;' ) ); ?>" target="_blank">
		<span class="wp-share-button__icon wp-share-button__icon--x">
			<?php
			$svg_path = get_template_directory() . '/vendor/inc2734/wp-share-buttons/src/assets/img/x.svg';
			if ( file_exists( $svg_path ) ) {
				include $svg_path;
			}
			?>
		</span>
		<span class="wp-share-button__label"><?php esc_html_e( 'Posts', 'inc2734-wp-share-buttons' ); ?></span>
	</a>
</div>
